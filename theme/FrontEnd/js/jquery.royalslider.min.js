...
(function (m) {
    function u(b, e) {
        ...
        a._d1 = 0;
        a.slidesJQ = [];
        for (c = 0; c < a.numSlides; c++) a.slidesJQ.push(m('<div style="' + (a._l ? "" : c !== a.currSlideId ? a._n : "z-index:0;") + '" class="rsSlide "></div>'));
        a._e1 = f = m(f + "</div></div>");
        var p = a.ns,
            h = function (b, d, c, e, g) {
                a._j1 = b + d + p;
                a._k1 = b + c + p;
                a._l1 = b + e + p;
                g && (a._m1 = b + g + p)
        ...
        a.msEnabled ? (a.msTouch = Boolean(1 < window.navigator.msMaxTouchPoints), a.hasTouch = !1, a._n1 = 0.2, h("MSPointer", "Down", "Move", "Up", "Cancel")) : (a.isIOS ? a._j1 = a._k1 = a._l1 =
            a._m1 = "" : h("mouse", "down", "move", "up", "up"), "ontouchstart" in window || "createTouch" in document ? (a.hasTouch = !0, a._j1 += " touchstart" + p, a._k1 += " touchmove" + p, a._l1 += " touchend" + p, a._m1 += " touchcancel" + p, a._n1 = 0.5, a.st.sliderTouch && (a._f1 = !0)) : (a.hasTouch = !1, a._n1 = 0.2));
        ...
        a._p1.click(function (b) {
            if (!a.dragSuccess) {
                ...
                if (-1 !== m.inArray(d, q) && a.toggleVideo()) return !1;
                if (a.st.navigateByClick && !a._h2) {
                    if (m(b.target).closest(".rsNoDrag", a._r1).length) return !0;
                    a._i2(b)
                }
    ...
    u.prototype = {
            ...
            function c(b, d) {
                ...
                if (h) {
                    ...
                    "undefined" !== typeof c && !1 !== c && "undefined" !==
                        typeof e && !1 !== e ? (f.iW = parseInt(c, 10), f.iH = parseInt(e, 10)) : a.st.imgWidth && a.st.imgHeight && (f.iW = a.st.imgWidth, f.iH = a.st.imgHeight)
                }
            }
            var a = this,
                g, f = {}, d, h = !0;
        ...
        _n2: function (b, e) {
            function c(c, e, f) {
                c.isAdded ? (a(e, c), g(e,
                    c)) : (f || (f = d.slidesJQ[e]), c.holder ? f = c.holder : (f = d.slidesJQ[e] = m(f), c.holder = f), c.appendOnLoaded = !1, g(e, c, f), a(e, c), d._p2(c, f, b), c.isAdded = !0)
            }
            ...
            var n = d.currSlideId,
                q, r = b ? Math.abs(d._o2 - d.currSlideId) >= d.numSlides - 1 ? 0 :
                    1 : d._y,
                s = Math.min(2, r),
                v = !1,
                u = !1,
            ...
            if (v)
                for (k = n; k < n + r + 1; k++) t = f(k), q = Math.floor((d._u - (n - k)) / d.numSlides) * d.numSlides, (h = d.slides[t]) && c(h, t);
            if (u)
                for (k = n - 1; k > n - 1 - r; k--) t = f(k), q = Math.floor((d._u - (n - k)) / p) * p, (h = d.slides[t]) && c(h, t);
            if (!b)
                for (s = f(n - r), n = f(n + r), r = s > n ? 0 : s, k = 0; k < p; k++) s > n && k > s - 1 || !(k < r || k > n) || (h = d.slides[k]) &&
            ...
            var c = this,
                a = function () {
                    if (!b.images) b.isRendered = !0, b.isLoaded = !0, b.isLoading = !1, d(!0);
                        ...
                        b.isLoading = !0;
                        if (b.isBig) m("<img />").on("load.rs error.rs", function (a) {
        ...
        _g2: function (b, e) {
            ...
            if (m(b.target).closest(".rsNoDrag", c._r1).length) return c.dragSuccess = !1, !0;
                ...
                if (g._s2 = !1, g.ev.trigger("rsDragRelease"), g._u3 = null, g._l2 = !1, g._r3 = !1, g._l3 = !1, g._m3 = 0, cancelAnimationFrame(g._t3), g._a3 && (e ? g._q3(g._h3) : g._l && g._p3(g._h3)), g._b.off(g._k1).off(g._l1), d && g._e1.off(g._m1), g._i1(), !g._a3 && !g._v2 && e && g._w3) {
                    ...
                    if (0 === v || 1 >= s) a(!0, d);
                        ...
                        if (e) {
                            ...
                            g._a4(h, l, !0)
                        } else q + p < n ? 0 > v ? a(!1, d) : g._m2("prev", c(Math.abs(g._p - (-g._u - g._d1 + 1) * g._w) / d), !1, !0, !0) : q - p > n ? 0 < v ? a(!1, d) : g._m2("next", c(Math.abs(g._p - (-g._u - g._d1 - 1) * g._w) /
                            d), !1, !0, !0) : a(!1, d)
                    }
                }
        },
        ...
        updateSliderSize: function (b) {
            ...
            if (this.st.autoScaleSlider) {
                ...
                this.st.autoScaleHeight ? (e = this.slider.width(), e != this.width && (this.slider.css("height", e * (g / a)), e = this.slider.width()), c = this.slider.height()) : (c = this.slider.height(), c != this.height && (this.slider.css("width",
                    c * (a / g)), c = this.slider.height()), e = this.slider.width())
        ...
        appendSlide: function (b, e) {
            ...
            this.slidesJQ.splice(e, 0, m('<div style="' + (this._l ? "position:absolute;" :
                this._n) + '" class="rsSlide"></div>'));
        ...
        _m2: function (b, e,
            ...
            k > f._y && (k = f._y);
            if (h > k + l)
                for (f._d1 += (h - (k + l)) * (n ? -1 : 1), e *= 1.4, k = 0; k < f.numSlides; k++) f.slides[k].positionSet = !1;
            f._c = e;
            f._n2(!0);
            g || (m = !0);
            d = (-a - f._d1) * f._w;
        ...
        _f2: function () {
            this.st.arrowsNav &&
                (1 >= this.numSlides ? (this._c2.css("display", "none"), this._d2.css("display", "none")) : (this._c2.css("display", "block"), this._d2.css("display", "block"), this._z || this.st.loopRewind || (0 === this.currSlideId ? this._c2.addClass("rsArrowDisabled") : this._c2.removeClass("rsArrowDisabled"), this.currSlideId === this.numSlides - 1 ? this._d2.addClass("rsArrowDisabled") : this._d2.removeClass("rsArrowDisabled"))))
        },
        _x3: function (b, e, c, a, g) {
            ...
            d._e ? d._l ? (d._c = parseInt(d._c, 10), c = d._g + d._v1, l[d._g + d._u1] = d._c + "ms", l[c] = a ? m.rsCSS3Easing[d.st.easeInOut] : m.rsCSS3Easing[d.st.easeOut], d._p1.css(l), a || !d.hasTouch ? setTimeout(function () {
                d._p3(b)
            }, 5) : d._p3(b)) : (d._c = d.st.transitionSpeed, h = d._g4, k = d._r1, k.data("rsTimeout") && k.css("opacity", 0), f(),
                ...
                }, 20))) : d._l ? (l[d._h ? d._x1 : d._w1] = b + "px", d._p1.animate(l,
                d._c, a ? d.st.easeInOut : d.st.easeOut)) : (h = d._g4, k = d._r1, k.stop(!0, !0).css({
                opacity: 0,
                display: "block",
                zIndex: d._m
        ...
        _l4: function () {
            ...
            return parseInt(b[this._h ? e ? 12 : 4 :
                e ? 13 : 5], 10)
        },
        _m4: function (b, e) {
            ...
            if (!b.isRendered) {
                ...
                if (c) {
                    ...
                    if ("none" !== d || f) {
                        ...
                        if ("fill" === d || "fit" === d) n = h / k, q = m / l, n = "fill" == d ? n > q ? n : q : "fit" == d ? n < q ? n : q : 1, k = Math.ceil(k * n, 10), l = Math.ceil(l * n, 10);
    ...
    m.fn.royalSlider = function (b) {
        ...
        return this.each(function () {
            ...
            if ("object" !== typeof b && b) {
                if ((c = c.data("royalSlider")) && c[b]) return c[b].apply(c, Array.prototype.slice.call(e,
                    1))
